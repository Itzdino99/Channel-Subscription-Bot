...
@bot.message_handler(func=lambda m: m.content_type == "text" and m.text == USER_NEXT)
...
@bot.message_handler(func=lambda m: m.content_type == "text" and m.text == USER_PREVIOUS)
...
def ultimate_admin_menu_markup(admin_id=None, page=None):
    ...
    buttons = [
        # Page 1 — primary management categories.
        ADMIN_CHANNELS,
        ADMIN_PREMIUM,
        ADMIN_USERS,
        ADMIN_COUPONS,
        ADMIN_SETTINGS,
        ADMIN_STATISTICS,
        # Page 2 — operational tools.
        ADMIN_MILESTONES,
        ADMIN_VERIFICATION,
        ADMIN_USER_SEARCH,
        ADMIN_COIN_ADD,
        ADMIN_PREMIUM_MANAGE,
        ADMIN_MAINTENANCE,
        # Page 3 — advanced/admin communication controls.
        ADMIN_ADVANCED,
        ADMIN_ANNOUNCEMENTS,
        ADMIN_SINGLE_BROADCAST,
        ADMIN_MODE,
    ]
