...
def support_ticket_user_router(message):
    ...
    panel_labels = {USER_PROFILE, USER_REFER, USER_EXTRA, USER_PREMIUM, USER_REFERRALS, USER_LEADERBOARD, USER_CONTACT,
                    USER_DAILY, USER_COUPON, USER_MILESTONES, USER_ANNOUNCEMENTS, USER_FEEDBACK,
                    USER_REDEEM, USER_GIFT, USER_RENEW, USER_BACK}
...
def _final_ui_router_match(message):
    ...
    labels = {
        ...
        USER_HISTORY, USER_EXPIRY_INFO, USER_HOW, USER_HELP, USER_ACHIEVEMENTS,
        ...
        FINAL_ADMIN_SETTINGS, FINAL_ADMIN_STATS, FINAL_ADMIN_LOGS, ADMIN_MODE, ADMIN_PANEL_BUTTON,
...
def final_ui_router(message):
    ...
    if uid == ADMIN_ID:
        ...
        if text in {FINAL_ADMIN_USERS, FINAL_ADMIN_PREMIUM, FINAL_ADMIN_COINS, FINAL_ADMIN_REWARDS,
                    FINAL_ADMIN_TICKETS, FINAL_ADMIN_BROADCAST, FINAL_ADMIN_COUPONS, FINAL_ADMIN_OFFERS,
...
def show_user_menu(chat_id):
    # FINAL USER PANEL — this is the only user main-menu keyboard.
    # Legacy handlers/features remain in the source but are not exposed here.
    ensure_final_feature_flags()
...
def _prioritize_advanced_handlers():
    ...
    priority = {
        ...
        "final_ui_router": -190,
        "final_requested_admin_router": -189,
    }
